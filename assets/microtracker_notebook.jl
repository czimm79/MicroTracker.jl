...
# ╔═╡ 27ce38dd-c87a-4216-868e-af4423712c4a
md"""
#### 🚧 Control Panel

Particle ➡ $(@bind chosen_particle_num Slider(1:length(fcd.particle_unique)))
"""

# ╔═╡ ef591280-c1e4-4ec8-bddc-a7706e99c414
begin
	showimagecheck = @bind showimage CheckBox()
	md"Show Image? (takes time) ➡ $showimagecheck"
end

# ╔═╡ 68682aa6-e6b3-453d-b405-130e4f07e44e
chosenparticle = fcd.particle_unique[chosen_particle_num]

# ╔═╡ 8e6c903d-e1fa-4e7b-80cd-1943df291438
begin
	@df fcd scatter(:R, :V, group=:B_mT, xlims=(0, 40), ylims=(0, 100), xlabel="R (µm)", ylabel="V (µm/s)", leg_title = "B (mT)", fontfamily="Helvetica")

	# Highlight the chosen particle for the trajectory analyzer
	chosenparticle_summary = @subset(collapsed_data, :particle_unique .== chosenparticle)
	@df chosenparticle_summary scatter!(:R, :V, ms=10, color=:red, marker=:cross, label="Chosen Particle")
end

# ╔═╡ dd04a3ac-b161-4c4a-b597-aff2d0b2cd23
begin
	frameslider = begin
	...
	md"Frame ➡ $frameslider"
end

# ╔═╡ e5a49cd2-49a1-4d13-9eec-dd68acc137b0
trajectory_analyzer(linked_data, fcd, chosenparticle, framenumber, showimage=showimage)

# ╔═╡ 5b6ab5d6-ff2f-4d15-849c-09cdeec166c0
md"### Animations
Uncomment the following cell to generate an example animation of a tracked microbot.
*This will take a few minutes, depending on your hardware.*
"

# ╔═╡ 53406fad-23f0-4409-bee8-32cb75f99060
#animate_trajectory_analyzer(linked_data, collapsed_data, "5_13p5_61p35-8", "my_animation.mp4")

# ╔═╡ 47d46061-0042-48a8-bf42-ca3530109d29
md"# Appendix
When rapidly loading images from microscopy video, the speed is limited by loading the image from your storage (hard drive or solid state drive) to your RAM. For best performance, I recommend an SSD with the highest read speeds you can get, the best currently being ~ 7 Gb/s for Gen4 PCIe M.2 SSDs. When microscopes regularly create videos ~30 Gb each, fast storage is incredibly useful for rapid analysis. See something like the WD_BLACK 2TB SN850X, \$160 at the time of writing.
"
...
[deps]
MicroTracker = "f2f4b30c-0e7b-4018-b992-2f46df5706a6"
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "aa9582c3b3fc6c257ca4ec0b5c8d44af520828ca"
...
[[deps.MicroTracker]]
deps = ["CSV", "Conda", "DataFrames", "DataFramesMeta", "FFTW", "FileIO", "ImageIO", "Optim", "PyCall", "Reexport", "Statistics", "StatsPlots"]
git-tree-sha1 = "713cde5f07339b289fb3c81e1a5155302d96a8bb"
